# Generated by Django 2.2.5 on 2019-09-18 18:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicants', models.ManyToManyField(blank=True, to='accounts.UserProfile')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='JobApplication', to='accounts.OrgProfile')),
                ('req_skills', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applied_job', to='accounts.JobApplication')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applied_user', to='accounts.UserProfile')),
            ],
        ),
        migrations.AddField(
            model_name='client',
