# Generated by Django 2.1.3 on 2019-09-10 04:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='job',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='applied_job', to='accounts.JobApplication'),
        ),
        migrations.AddField(
            model_name='appliedjobs',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='applied_user', to='accounts.UserProfile'),
        ),
    ]
